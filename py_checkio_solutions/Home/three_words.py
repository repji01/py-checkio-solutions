#!/home/mattie/.local/bin/checkio --domain=py run three-words
...
import re
def checkio(words):
    return True if re.search('[a-z]+ [a-z]+ [a-z]+', words.lower()) else False


#These "asserts" using only for self-checking and not necessary for auto-testing
if __name__ == '__main__':
    assert checkio("one two 3 four five six 7 eight 9 ten eleven 12") == True,"cc"
