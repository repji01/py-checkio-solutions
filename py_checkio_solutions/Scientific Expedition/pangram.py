#!/home/mattie/.local/bin/checkio --domain=py run pangram
...
def check_pangram(text):
    ...
    '''
    # your code here
    return not (set(string.ascii_lowercase) - set(''.join(c for c in text if c not in (string.punctuation + " ")).lower()))
